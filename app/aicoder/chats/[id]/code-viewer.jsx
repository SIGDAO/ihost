    ...
    <>
        ...
        {layout === "tabbed" && (
          <div className="rounded-lg border-2 border-gray-300 p-1">
            <button
              ...
              className="inline-flex h-7 w-16 items-center justify-center rounded text-xs font-medium text-gray-200 data-[active]:bg-blue-500 data-[active]:text-white"
            >
              Code
            </button>
            <button
      ...
      <div className="flex items-center justify-between border-t border-gray-300 px-4 py-4">
        <div className="inline-flex items-center gap-2.5 text-sm">
          ...
          <button
            className="inline-flex items-center gap-1 rounded border border-gray-300 px-1.5 py-0.5 text-sm text-gray-600 transition enabled:hover:bg-white disabled:opacity-50 text-gray-200"
