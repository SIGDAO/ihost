  ...
  return (
    <div>
      {parts.map((part, i) => (
        <div key={i}>
          {part.type === "text" ? (
             <Markdown className="prose prose-strong:text-gray-100 prose-h3:text-gray-100 prose-code:text-sky-400 text-gray-300">{part.content}</Markdown>
...
export function toTitleCase(rawName){
