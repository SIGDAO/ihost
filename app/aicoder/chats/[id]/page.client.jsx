...
import { createMessage } from "@/app/aicoder/actions";
...
export default function PageClient({ chat }) {
  const context = use(Context);
  const [streamPromise, setStreamPromise] = useState(context.streamPromise);
