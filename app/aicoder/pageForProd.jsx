...
// avoid error when deploying to vercel
"use client";
//original
    ...
    <main style={{ background: bgColor, minHeight: "100vh" }}>
        ...
        {currentApp === "team" || currentApp === "partners" || isLoggedIn ? (
          ...
          <h1 className="mt-4 text-balance text-center text-4xl leading-none text-white md:text-[64px] lg:mt-8">
                    Build<span className="text-blue-500"> Dapp</span>  easier, faster & smarter. 
                    </h1>
                    ...
                    action={async (formData) => {
                      startTransition(async () => {
                        ...
                        startTransition(() => {
                          ...
                          router.push(`/aicoder/chats/${chatId}`);
                        });
                      });
                    }}
                  >
                ...
                <footer className="flex w-full flex-col items-center justify-between space-y-3 px-3 pb-3 pt-5 text-white text-center sm:flex-row sm:pt-2">
                  <div>
