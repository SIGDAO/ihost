const toBoolean = (v) => v.toLowerCase() === "true";

const withoutTrailingSlash = (url) => url.endsWith('/') ? url.substring(0, url.length -1) : url
...
export const Config = {
  ...
  Ledger: {
    ...
    // Network: process.env.NEXT_PUBLIC_SIGNUM_NETWORK || "Signum-TESTNET" ,  (TEST Mode)
