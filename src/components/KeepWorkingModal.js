...
const KeepWorkingModal = () => {
  ...
  return (
    <Modal
      isOpen={isKeepWorkingModal}
      onClose={() => setIsKeepWorkingModal(false)}
      isCentered
    >
      <ModalOverlay />
      <ModalContent>
        ...
        <ModalBody>
          <Flex flexDir="column" justifyContent="center" alignItems="center">
            ...
            <Text mt=".5em">
              Looks like you&apos;re still working on the{" "}
              {paymentData?.redirect?.title}
            </Text>
          ...
          {paymentData?.service === "Website" ? (
            <Link href={paymentData?.redirect?.origin}>
              <Button
                ...
                size="sm"
                onClick={() => setIsKeepWorkingModal(false)}
              >
