...
import ConnectWalletTag from "./ConnectWalletTagAR";
                ...
                {item.items.map((nav, idx) => (
                  <Box key={idx} w="full">
                    {!nav.isExternal ? (
                      ...
                      <NextLink href={nav.link === "/aicoder" ? `/aicoder` : `/dashboard${nav.link}`} shallow passHref>
                        <Button
                          borderRadius="0"
                          leftIcon={nav.icon}
                          w="full"
                      ...
                      {nav.children.map((children, idx) => (
                        ...
                        >
                          <Button
                            ...
                            _focus={{ bg: "transparent" }}
                            color={
                              currentApp === ("approuter").toLowerCase()
                                ? "rgb(52,140,212)"
                                : null
                            }
                          >
