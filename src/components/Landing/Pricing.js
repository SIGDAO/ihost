  ...
  return (
    ...
    >
      ...
      <Wrap justify="center" my="4em" w="full" maxW="1200px" spacing="10em">
        <Flex flexDir="column">
          <Text fontWeight="semibold">Collection Generator</Text>
          <HStack>
            <Text fontWeight="bold" fontSize="18pt">
              Free or $25
            </Text>
            <Text variant="subtle">/ Generation</Text>
          </HStack>
        ...
        <Flex flexDir="column">
          <Text fontWeight="semibold">Minting Website Hosting</Text>
          <HStack>
            <Text fontWeight="bold" fontSize="18pt">
              Free or $15
            </Text>
            <Text variant="subtle">/ Website</Text>
          </HStack>
          <HStack w="full" maxW="250px" mt="2em">
            <Box borderRadius="5px" p=".5em" bg="gray.600" />
        ...
        <Flex flexDir="column">
          <Text fontWeight="semibold">Metadata Utilities</Text>
          <HStack>
            <Text fontWeight="bold" fontSize="18pt">
              Free or $5
            </Text>
            <Text variant="subtle">/ Modification</Text>
          </HStack>
          <HStack w="full" maxW="250px" mt="2em">
            <Box borderRadius="5px" p=".5em" bg="gray.600" />
