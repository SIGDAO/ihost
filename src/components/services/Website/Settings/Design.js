        ...
        <Flex flexDir="column">
          <VStack spacing=".25em" alignItems="flex-start">
            ...
            <Text fontSize="10pt" variant="subtle">
              An external link to an Icon file representing your website. This
              will be displayed on your browser&apos;s tab.
            </Text>
          </VStack>
          <DynamicInput
            id="favicon"
        ...
        <Flex justifyContent="flex-end" mt="1em">
          <Button
            ...
            disabled={
              ...
              isUpdatingWebsite ||
              !favicon.length ||
              favicon === editingWebsite?.meta?.favicon
            }
      ...
      >
        <Flex flexDir="column">
          <VStack spacing=".25em" alignItems="flex-start">
            <Text>Logo URL</Text>
            <Text fontSize="10pt" variant="subtle">
              An external link to an Image file representing your website. This
              will be displayed on your browser&apos;s tab.
            </Text>
          </VStack>
          <DynamicInput
        ...
        <Flex justifyContent="flex-end" mt="1em">
          <Button
            ...
            disabled={
              ...
              isUpdatingWebsite ||
              !logo.length ||
              logo === editingWebsite?.components?.unrevealedImage
            }
            isLoading={isUpdatingWebsite}
            loadingText="Saving"
          >
      ...
      >
        <Flex flexDir="column">
          <VStack spacing=".25em" alignItems="flex-start">
            ...
            <Text fontSize="10pt" variant="subtle">
              An external link to all your social medias. This will be displayed
              on the website.
            </Text>
          </VStack>
            ...
            <HStack w="full">
              ...
              <Button
                ...
                disabled={
                  editingWebsite?.isExpired ||
                  isUpdatingWebsite ||
                  twitter === editingWebsite?.externalLinks?.twitter
                }
                isLoading={isUpdatingWebsite}
                loadingText="Saving"
              >
            ...
            <HStack w="full">
              ...
              <Button
                ...
                disabled={
                  editingWebsite?.isExpired ||
                  isUpdatingWebsite ||
                  opensea === editingWebsite?.externalLinks?.opensea
                }
                isLoading={isUpdatingWebsite}
                loadingText="Saving"
              >
            ...
            <HStack w="full">
              ...
              <Button
                ...
                disabled={
                  editingWebsite?.isExpired ||
                  isUpdatingWebsite ||
                  discord === editingWebsite?.externalLinks?.discord
                }
                isLoading={isUpdatingWebsite}
                loadingText="Saving"
              >
            ...
            <HStack w="full">
              ...
              <Button
                ...
                disabled={
                  editingWebsite?.isExpired ||
                  isUpdatingWebsite ||
                  reddit === editingWebsite?.externalLinks?.reddit
                }
                isLoading={isUpdatingWebsite}
                loadingText="Saving"
              >
            ...
            <HStack w="full">
              ...
              <Button
                ...
                disabled={
                  editingWebsite?.isExpired ||
                  isUpdatingWebsite ||
                  tiktok === editingWebsite?.externalLinks?.tiktok
                }
                isLoading={isUpdatingWebsite}
                loadingText="Saving"
              >
            ...
            <HStack w="full">
              ...
              <Button
                ...
                disabled={
                  editingWebsite?.isExpired ||
                  isUpdatingWebsite ||
                  youtube === editingWebsite?.externalLinks?.youtube
                }
                isLoading={isUpdatingWebsite}
                loadingText="Saving"
              >
            ...
            <HStack w="full">
              ...
              <Button
                ...
                disabled={
                  editingWebsite?.isExpired ||
                  isUpdatingWebsite ||
                  instagram === editingWebsite?.externalLinks?.instagram
                }
                isLoading={isUpdatingWebsite}
                loadingText="Saving"
              >
            ...
            <HStack w="full">
              ...
              <Button
                ...
                disabled={
                  editingWebsite?.isExpired ||
                  isUpdatingWebsite ||
                  facebook === editingWebsite?.externalLinks?.facebook
                }
                isLoading={isUpdatingWebsite}
                loadingText="Saving"
              >
