  ...
  return (
    <VStack alignItems="flex-start" mt="1em" flex="1" spacing="2em">
      {!editingWebsite?.isPremium && !editingWebsite?.isExpired && (
        <Flex alignItems="flex-end" maxW="865px" w="full" flexDir="column">
          <Flex
            flexDir="column"
            bg={containerColor}
            p="1em"
          ...
          >
            ...
            <Text variant="subtle">- Custom Domain Support</Text>
            <Text variant="subtle">- Unlimited Premium Minting Websites</Text>
          </Flex>
        </Flex>
      )}
        ...
        <Flex alignItems="flex-end" maxW="865px" w="full" flexDir="column">
          ...
          >
            <HStack color="red.500">
              ...
              <Text color="red.500">Action Required</Text>
            </HStack>
        ...
        <Flex flexDir="column">
          <VStack spacing=".25em" alignItems="flex-start">
            ...
            <Text fontSize="10pt" variant="subtle">
              Used to identify your Project on the Dashboard and main heading
              that will displayed.
            </Text>
          </VStack>
          <DynamicInput
        ...
        <Flex justifyContent="flex-end" mt="1em">
          <Button
            ...
            disabled={
              ...
              isUpdatingWebsite ||
              !title.length ||
              title === editingWebsite?.components?.title
            }
        ...
        <Flex justifyContent="flex-end" mt="1em">
          <Button
            ...
            disabled={
              ...
              isUpdatingWebsite ||
              !description.length ||
              description === editingWebsite?.components?.description
            }
            isLoading={isUpdatingWebsite}
            loadingText="Saving"
          >
        ...
        <Flex justifyContent="flex-end" mt="1em">
          <Button
            ...
            disabled={
              ...
              isUpdatingWebsite ||
              !language.length ||
              language === editingWebsite?.meta?.language
            }
            isLoading={isUpdatingWebsite}
            loadingText="Saving"
          >
        ...
        <Flex justifyContent="flex-end" mt="1em">
          <Button
            ...
            disabled={
              editingWebsite?.isExpired ||
              isUpdatingWebsite ||
              script === editingWebsite?.components?.script
            }
            isLoading={isUpdatingWebsite}
            loadingText="Saving"
          >
      ...
      >
        <Flex flexDir="column">
          <VStack spacing=".25em" alignItems="flex-start">
            <Text>Embed</Text>
            <Text fontSize="10pt" variant="subtle">
              Embed code from third-party services that displays the mint
              button.
            </Text>
          </VStack>
          <DynamicInput
        ...
        <Flex justifyContent="flex-end" mt="1em">
          <Button
            ...
            disabled={
              ...
              isUpdatingWebsite ||
              !embed.length ||
              embed === editingWebsite?.components?.embed
            }
            isLoading={isUpdatingWebsite}
            loadingText="Saving"
          >
        ...
        <Flex justifyContent="flex-end" mt="1em">
          <Button
            ...
            disabled={
              ...
              isUpdatingWebsite ||
              !robot.length ||
              robot === editingWebsite?.meta?.robot
            }
            isLoading={isUpdatingWebsite}
            loadingText="Saving"
          >
      ...
      >
        <Flex flexDir="column">
          <VStack spacing=".25em" alignItems="flex-start">
            ...
            <Text fontSize="10pt" variant="subtle">
              The Website will be permanently deleted. This action is
          ...
          <Text fontSize="10pt" mt="1em">
            ...
            <span style={{ fontStyle: "italic" }}>
              delete {editingWebsite?.components?.title}
            </span>
        ...
        <Flex justifyContent="flex-end" mt="1em">
          <Button
            ...
            disabled={
              isDeletingWebsite ||
              deleteInput !== `delete ${editingWebsite?.components?.title}`
            }
