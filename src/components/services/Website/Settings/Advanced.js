...
const Advanced = () => {
  ...
  const { updateIsPublished, updateRevealDate, isUpdatingWebsite } =
    useWebsiteControls();
        ...
        <Flex flexDir="column">
          <VStack spacing=".25em" alignItems="flex-start">
            ...
            <Text fontSize="10pt" variant="subtle">
              Toggle to make your website viewable or not. Don&apos;t Forget to
              press Save.
            </Text>
          </VStack>
          <DynamicInput
        ...
        <Flex justifyContent="flex-end" mt="1em">
          <Button
            ...
            disabled={
              ...
              isUpdatingWebsite ||
              isPublished === editingWebsite?.isPublished
            }
        ...
        <Flex justifyContent="flex-end" mt="1em">
          <Button
            ...
            disabled={
              ...
              isUpdatingWebsite ||
              !revealDate.length ||
              revealDate === convertDateToLocal(editingWebsite?.revealDate)
            }
            isLoading={isUpdatingWebsite}
            loadingText="Saving"
          >
