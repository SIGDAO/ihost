...
const Templates = () => {
  ...
  const { updateTemplate, isUpdatingWebsite } = useWebsiteControls();
      ...
      {editingWebsite ? (
        <Flex flexDir="column" mt="1em" p="1em">
          <HStack alignItems="center" w="full" mt="1em">
            <Text fontSize="10pt">NFT Host Templates</Text>
            <Divider flex="1" />
          </HStack>
          <Text my=".5em" variant="subtle">
            You will see changes in your minting website 30 seconds after you
          ...
          <Wrap spacing="2em" mt="2em">
            {templatesArr
              ?.filter(({ filterKey }) => filter.includes(filterKey))
              .map((template, idx) => (
                <Flex
                  flexDir="column"
                  p="1em"
                ...
                >
                  ...
                  >
                    <Box w="250px" h="125px" overflow="hidden">
                      <Link
                        href={`${config?.clientUrl}/assets/templates/${template.key}.png`}
                        boxSize="250px"
                        isExternal
                      >
                        <Image
                    ...
                    <Wrap justify="flex-start" w="full" gap=".5em">
                      <Tag size="sm">
                        {template.sub === "premium" && (
                          <TagLeftIcon as={GiCutDiamond} color="orange" />
                        )}
                        <Text>
