...
const Template7 = () => {
  ...
  return (
    <Flex
      ...
      alignItems="center"
    >
      <Flex flexDir="column" w="full" alignItems="center" flex="1">
        <Flex
          w="full"
          maxW="1260px"
          p="2em"
      ...
      >
        <Flex
          ...
          borderRadius="10px"
        >
          <Text fontSize="20pt">{userWebsite?.components?.title}</Text>
          <Text fontSize="14pt">{userWebsite?.components?.description}</Text>
        </Flex>
      </Flex>
    </Flex>
  );
