...
>
  ...
  <Stack>
    ...
    <CardFooter>
      ...
      Start my first dapp with signum blockchain<ExternalLinkIcon mx='2px' />
      </Link>
      ...
      <CardFooter>
      <Button variant='solid' colorScheme='blue'>
      <Link color={'black'} href='https://bdiy.vercel.app/' isExternal>
      Use ai coder to generate new dapp<ExternalLinkIcon mx='2px' />
      </Link>
