...
const AliasResultsList = ({ results ,searchItem, toast , buttonDisable, setButtonDisable}) => {
  ...
  <Stack w="1000px">
    ...
    <CardFooter>
      ...
      {(result[1].priceNQT)/1000000000} SIGNA
        ...
        <Spacer />
      <Button onClick={()=> setAlias(result)} 
      isDisabled={ (result[1].status === "Taken" ? true : false) || buttonDisable } 
      variant='solid' 
